...
class _CategoriesState extends State<Categories> {
  final List<Map<String, dynamic>> products = [
...

    {
      ...
      "image":
          "https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcReIy9GE4JJVFkA72sPF9bsMxkhYhGPffqZ4dB5AsSu-7USNMmbpXgSpXucanXMg91oa7vCM1MoZlgDRtWbP9NBEdYVbb6KdH1l2n2EPIM",
    },
  ...
  void filterCategorySearch() {
    final query = _searchController.text.toLowerCase();

    // First get only this category
    ...
    setState(() {
      if (query.isEmpty) {
        ...
        filtered = categoryProducts.where((item) {
          ...
          children: [
            ...
            Expanded(
              child: filtered.isEmpty
                  ? buildNoResults() // show message
                  : buildingproducts(filtered), // show products
            ),
          ],
        ),
      ),
  ...
  GridView buildingproducts(List<Map<String, dynamic>> filtered) {
                          ...
                          return ScaleTransition(
                            scale: Tween(begin: 0.95, end: 1.0).animate(
                              CurvedAnimation(
                                parent: animation,
                                curve:
                                    Curves.easeOutCirc, // <-- slower, smoother
                              ),
                            ),
